...
/**
 * This exception will be thrown when a setting is not found and there is no default value for it.
 */
class SettingNotFound(settingName: String) : RuntimeException("Setting '$settingName' not found.")
